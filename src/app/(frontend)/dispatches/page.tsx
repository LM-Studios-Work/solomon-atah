    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      {result.docs.length === 0 ? (
        ...
        <div className="space-y-0 divide-y divide-border">
          {result.docs.map((dispatch) => {
            const coverImage =
              typeof dispatch.coverImage === 'object' && dispatch.coverImage !== null
                ? dispatch.coverImage
                : null
            ...
            return (
              <article key={dispatch.id} className="py-8 grid sm:grid-cols-4 gap-6 items-start">
                  ...
                  <div className="sm:col-span-1">
                    <div className="relative aspect-[4/3] bg-muted rounded-sm overflow-hidden">
                      <Image
                        ...
                        alt={(coverImage as { alt: string }).alt || dispatch.title}
                        fill
                ...
                <div className={coverImage ? 'sm:col-span-3' : 'sm:col-span-4'}>
